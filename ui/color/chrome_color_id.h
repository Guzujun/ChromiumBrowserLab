...
#define COMMON_CHROME_COLOR_IDS \
  ...
  /* The colors used for tab groups in the tabstrip.(User Defined) */ \
  /*June*/\
  E_CPONLY(kColorTabGroupCustom0)\
  E_CPONLY(kColorTabGroupCustom1)\
  E_CPONLY(kColorTabGroupCustom2)\
  E_CPONLY(kColorTabGroupCustom3)\
  E_CPONLY(kColorTabGroupCustom4)\
  E_CPONLY(kColorTabGroupCustom5)\
  E_CPONLY(kColorTabGroupCustom6)\
  E_CPONLY(kColorTabGroupCustom7)\
  E_CPONLY(kColorTabGroupCustom8)\
  /* Tab Search colors */ \
