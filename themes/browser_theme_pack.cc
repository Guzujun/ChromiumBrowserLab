...
constexpr StringToIntTable kOverwritableColorTable[] = {
    ...
    // June
    {"tab_group_custom0", ThemeProperties::COLOR_TAB_GROUP_CUSTOM0},
    {"tab_group_custom1", ThemeProperties::COLOR_TAB_GROUP_CUSTOM1},
    {"tab_group_custom2", ThemeProperties::COLOR_TAB_GROUP_CUSTOM2},
    {"tab_group_custom3", ThemeProperties::COLOR_TAB_GROUP_CUSTOM3},
    {"tab_group_custom4", ThemeProperties::COLOR_TAB_GROUP_CUSTOM4},
    {"tab_group_custom5", ThemeProperties::COLOR_TAB_GROUP_CUSTOM5},
    {"tab_group_custom6", ThemeProperties::COLOR_TAB_GROUP_CUSTOM6},
    {"tab_group_custom7", ThemeProperties::COLOR_TAB_GROUP_CUSTOM7},
    {"tab_group_custom8", ThemeProperties::COLOR_TAB_GROUP_CUSTOM8},
    // /!\ If you make any changes here, you must also increment
    // kThemePackVersion above, or else themes will display incorrectly.
};
...
bool BrowserThemePack::GetColor(int id, SkColor* color) const {
  static constexpr auto kOpaqueColors =
      base::MakeFixedFlatSet<TP::OverwritableByUserThemeProperty>({
          ...
          // June
          TP::COLOR_TAB_GROUP_CUSTOM0,
          TP::COLOR_TAB_GROUP_CUSTOM1,
          TP::COLOR_TAB_GROUP_CUSTOM2,
          TP::COLOR_TAB_GROUP_CUSTOM3,
          TP::COLOR_TAB_GROUP_CUSTOM4,
          TP::COLOR_TAB_GROUP_CUSTOM5,
          TP::COLOR_TAB_GROUP_CUSTOM6,
          TP::COLOR_TAB_GROUP_CUSTOM7,
          TP::COLOR_TAB_GROUP_CUSTOM8,
...
void BrowserThemePack::AddColorMixers(ui::ColorProvider* provider,
  ...
  constexpr struct {
    ...
    int color_id;
      ...
      // June 
      {TP::COLOR_TAB_GROUP_CUSTOM0, kColorTabGroupCustom0},
      {TP::COLOR_TAB_GROUP_CUSTOM1, kColorTabGroupCustom1},
      {TP::COLOR_TAB_GROUP_CUSTOM2, kColorTabGroupCustom2},
      {TP::COLOR_TAB_GROUP_CUSTOM3, kColorTabGroupCustom3},
      {TP::COLOR_TAB_GROUP_CUSTOM4, kColorTabGroupCustom4},
      {TP::COLOR_TAB_GROUP_CUSTOM5, kColorTabGroupCustom5},
      {TP::COLOR_TAB_GROUP_CUSTOM6, kColorTabGroupCustom6},
      {TP::COLOR_TAB_GROUP_CUSTOM7, kColorTabGroupCustom7},
      {TP::COLOR_TAB_GROUP_CUSTOM8, kColorTabGroupCustom8}
      };
  ...
  // June
  if(GetColor(TP:: COLOR_TAB_GROUP_CUSTOM0, &color)){

    mixer[kColorTabGroupTabStripFrameActiveGrey] =  {kColorTabGroupCustom0};
    // ui::SelectBasedOnDarkInput(kColorTabBackgroundInactiveFrameActive,
    //     kColorTabGroupCustom0, kColorTabGroupCustom0);
    mixer[kColorTabGroupContextMenuGrey] = {kColorTabGroupCustom0};
    // ui::SelectBasedOnDarkInput(kColorTabBackgroundInactiveFrameActive,
    //   kColorTabGroupCustom0, kColorTabGroupCustom0);
  }
  if(GetColor(TP:: COLOR_TAB_GROUP_CUSTOM1, &color)){
    // mixer[kColorTabGroupTabStripFrameActiveBlue] = {kColorTabGroupCustom1};
    // mixer[kColorTabGroupTabStripFrameInactiveBlue] = {kColorTabGroupCustom1};

    mixer[kColorTabGroupTabStripFrameActiveBlue] = {kColorTabGroupCustom1};
    mixer[kColorTabGroupContextMenuBlue] =  {kColorTabGroupCustom1};
    
  }
  if(GetColor(TP:: COLOR_TAB_GROUP_CUSTOM2, &color)){
    // mixer[kColorTabGroupTabStripFrameActiveRed] = {kColorTabGroupCustom2};
    mixer[kColorTabGroupTabStripFrameActiveRed] = {kColorTabGroupCustom2};
    mixer[kColorTabGroupContextMenuRed] =  {kColorTabGroupCustom2};
  }
  if(GetColor(TP:: COLOR_TAB_GROUP_CUSTOM3, &color)){
    mixer[kColorTabGroupTabStripFrameActiveYellow] = {kColorTabGroupCustom3};
    mixer[kColorTabGroupContextMenuYellow] =  {kColorTabGroupCustom3};
  }
  if(GetColor(TP:: COLOR_TAB_GROUP_CUSTOM4, &color)){
    mixer[kColorTabGroupTabStripFrameActiveGreen] = {kColorTabGroupCustom4};
    mixer[kColorTabGroupContextMenuGreen] =  {kColorTabGroupCustom4};
  }
  if(GetColor(TP:: COLOR_TAB_GROUP_CUSTOM5, &color)){
    mixer[kColorTabGroupTabStripFrameActivePink] = {kColorTabGroupCustom5};
    mixer[kColorTabGroupContextMenuPink] =  {kColorTabGroupCustom5};
    
  }
  if(GetColor(TP:: COLOR_TAB_GROUP_CUSTOM6, &color)){
    mixer[kColorTabGroupTabStripFrameActivePurple] = {kColorTabGroupCustom6};
    mixer[kColorTabGroupContextMenuPurple] =  {kColorTabGroupCustom6};
  
  }
  if(GetColor(TP:: COLOR_TAB_GROUP_CUSTOM7, &color)){
    mixer[kColorTabGroupTabStripFrameActiveCyan] = {kColorTabGroupCustom7};
    mixer[kColorTabGroupContextMenuCyan] =  {kColorTabGroupCustom7};

  }
  if(GetColor(TP:: COLOR_TAB_GROUP_CUSTOM8, &color)){
    mixer[kColorTabGroupTabStripFrameActiveOrange] = {kColorTabGroupCustom8};
    mixer[kColorTabGroupContextMenuOrange] =  {kColorTabGroupCustom8};
