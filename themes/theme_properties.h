...
class ThemeProperties {
 public:
  ...
  enum OverwritableByUserThemeProperty {
    ...
    // June
    // === 新增自定义 Tab Group 颜色 Start ===
    // 这 9 个枚举就是第三方主题可以在 JSON 里自定义的颜色键
    COLOR_TAB_GROUP_CUSTOM0,
    COLOR_TAB_GROUP_CUSTOM1,
    COLOR_TAB_GROUP_CUSTOM2,
    COLOR_TAB_GROUP_CUSTOM3,
    COLOR_TAB_GROUP_CUSTOM4,
    COLOR_TAB_GROUP_CUSTOM5,
    COLOR_TAB_GROUP_CUSTOM6,
    COLOR_TAB_GROUP_CUSTOM7,
    COLOR_TAB_GROUP_CUSTOM8,
    // === 新增自定义 Tab Group 颜色 End ===
